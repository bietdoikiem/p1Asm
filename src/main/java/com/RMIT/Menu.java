...
//    public void Input_lead(){ // this function used for adding lead
...
//    public void updateLead(){ // this function used for updating leads
...
//    }
//
//    public void DeleteLead(){ // function to delete an lead by ID
...
//    }
//
//    public static String input_name(){ // Valid the name of the lead by make sure it only contains letter from a-z
...
//    }
//
//    private static String input_phone(){ // get the phone after validated
...
//    }
//
//    private static String input_email(){ // get the email from user and validate it
...
//    }
//
//    private static String input_address(){ // get and validate address from users
...
//            System.out.println("Type 4 for adding a new interaction");
//            System.out.println("Type 5 for updating an interaction");
//            System.out.println("Type 6 for deleting an interaction");
...
//                        break;
//                    case "4":
//                        Menu.getInstance().InputInter();
//                        break;
//                    case "5":
//                        Menu.getInstance().updateInter();
//                        break;
//                    case "6":
//                        Menu.getInstance().DeleteInter();
//                        break;
//                }
//            }else {
...
//    }
//
//    public void InputInter(){ // input inter
...
////    private
//
//    private static String getMean(){ // get the mean from user and validate it
...
//    }
//
//    private static String getPotential(){ // get the potential from user and return the validated input
...
//    }
//
//    public void updateInter(){ // this function used for updating leads
//        // get the id of lead need to update
...
//        System.out.println("CRM on ");
//        System.out.println("Enter a number to activate the valid function: ");
//        System.out.println("Type 1 for adding a new leads");
//        System.out.println("Type 2 for update an existed leads");
//        System.out.println("Type 3 for delete an leads");
//        System.out.println("Type 4 for adding a new interaction");
